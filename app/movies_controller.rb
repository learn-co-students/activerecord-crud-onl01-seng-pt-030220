...
def can_be_found_updated_and_saved
  ...
  my_mov = Movie.find_by(title:"Awesome Flick")
  my_mov.title = "Even Awesomer Flick"
  my_mov.save
end
...
def can_update_using_update_method
  ...
  my_mov = Movie.find_by(title: "Wat?")
  my_mov.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  my_mov = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  my_mov.delete
end
